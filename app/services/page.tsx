...
export const metadata: Metadata = {
  ...
  description:
    "Explore Jeje Cake Bakery's premium cake services including weddings, birthdays, corporate events, and custom orders.",
};
...
const SERVICES_DATA = [
  {
    ...
    description:
      "From wildly creative children's shapes to deeply sophisticated milestones, we craft unforgettable centerpieces to celebrate life.",
    image: images.services[0].image,
  },
  {
    title: "Wedding Cakes",
    description:
      "Elegant, multi-tier architectural masterpieces meticulously designed to match your theme and feed the entire reception.",
    image: images.services[1].image,
  },
  {
    title: "Kitchen Party Cakes",
    description:
      "Beautiful, thematic celebration cakes formatted structurally to properly honor the bride-to-be during classic kitchen parties.",
    image: images.services[2].image,
  },
  {
    title: "Graduation Cakes",
    description:
      "Commemorate immense academic achievements with fully personalized structural achievements reflecting specific university colors.",
    image: images.services[3].image,
  },
  {
    title: "Anniversary Cakes",
    description:
      "Relive your best moments together via romantically styled cakes showcasing elegant fondants and romantic sugar flower blooms.",
    image: images.services[4].image,
  },
  {
    title: "Custom Themed Events",
    description:
      "Corporate branding, sports themes, or fantasy sculptures. If you can dream the theme up, our bakery engineers can build it.",
    image: images.services[5].image,
  },
];
        ...
        <section className="py-20 px-6 max-w-[1200px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10">
            {SERVICES_DATA.map((service, index) => (
              <div
                key={index}
                className="bg-white rounded-3xl overflow-hidden shadow-lg shadow-brand-pink/5 hover:shadow-2xl hover:shadow-brand-pink/20 transition-all duration-300 group flex flex-col"
              >
                ...
                <div className="p-8 flex flex-col flex-grow">
                  ...
                  <div className="pt-4 border-t border-brand-soft">
                    <span className="text-brand-deep font-medium group-hover:underline">
                      Learn more &rarr;
                    </span>
                  </div>
                </div>
        ...
        <section className="py-20 mt-10 bg-brand-soft">
          <div className="max-w-[1000px] mx-auto px-6 text-center">
            ...
            <p className="font-sans text-lg md:text-xl text-neutral-body max-w-2xl mx-auto mb-16">
              Ordering a custom cake shouldn&apos;t be stressful. We&apos;ve
              streamlined our consultancy process to flawlessly capture your
              dream design.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-6 relative">
              ...
              <div className="relative z-10 flex flex-col items-center">
                ...
                <h4 className="font-heading text-2xl font-semibold text-neutral-heading mb-3">
                  Consultation
                </h4>
                <p className="text-neutral-body px-4">
                  Contact us via WhatsApp with your date, portion sizing, and
              ...
              <div className="relative z-10 flex flex-col items-center">
                ...
                <p className="text-neutral-body px-4">
                  We supply flavor profiles and draft a formal cake design
                  sketch to lock in visual expectations.
                </p>
              </div>
              ...
              <div className="relative z-10 flex flex-col items-center">
                ...
                <p className="text-neutral-body px-4">
                  We safely transport and securely assemble the final
                  architectural tier directly at your venue.
                </p>
              </div>
            </div>
            ...
            <div className="mt-20">
              <Link
                href="/contact"
                className="inline-flex items-center justify-center bg-brand-pink text-white border-none hover:bg-brand-deep rounded-[12px] px-10 py-4 text-xl font-medium transition-colors shadow-lg focus:outline-none focus:ring-2 focus:ring-brand-deep"
              >
