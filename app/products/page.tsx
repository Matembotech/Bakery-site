...
export const metadata: Metadata = {
  ...
  description: "Explore Jeje Cake Bakery's full collection of fresh, premium cakes spanning birthdays, weddings, special occasions, and luxury custom options.",
};

const PRODUCTS_DATA = [
  {
    name: "Chocolate Birthday Cake",
    description: "Decadent dark chocolate layers enveloped in rich fudge frosting.",
    image: "/fallback/product-chocolate.webp",
    category: "Birthday"
  },
  {
    name: "Vanilla Wedding Tier",
    description: "Multi-layered Madagascar vanilla sponge with creamy swiss meringue buttercream.",
    image: "/fallback/product-wedding.webp",
    category: "Wedding"
  },
  {
    name: "Red Velvet Bliss",
    description: "Deep crimson cocoa tones paired perfectly with tangy cream cheese frosting.",
    image: "/fallback/product-redvelvet.webp",
    category: "Special Occasion"
  },
  {
    name: "Fruit Celebration Cake",
    description: "Light angel food sponge heavily loaded with seasonal fresh tropical fruits.",
    image: "/fallback/product-fruit.webp",
    category: "Special Occasion"
  },
  {
    name: "Custom Theme Sculptures",
    description: "Fully engineered fondant architectures carved specifically to your requests.",
    image: "/fallback/product-custom.webp",
    category: "Custom"
  },
  {
    name: "Luxury White Lace",
    description: "Elaborately piped edible white lace patterns cascading down royal icing tiers.",
    image: "/fallback/product-luxury.webp",
    category: "Wedding"
  },
  {
    name: "Lemon Raspberry Zing",
    description: "Tart lemon curd interspersed with fresh raspberry purees within vanilla cake.",
    image: "/fallback/product-lemon.webp",
    category: "Birthday"
  },
  {
    name: "Gourmet Cupcake Box",
    description: "Assorted dozen of our best-selling cake flavors miniaturized perfectly.",
    image: "/fallback/product-cupcakes.webp",
    category: "Cupcakes"
  }
];
    ...
    <>
      ...
      <main className="min-h-screen bg-neutral-cream pt-24 pb-20">
        ...
        <section className="relative w-full h-[40vh] md:h-[50vh] min-h-[400px]">
          <Image
            src="/fallback/product-banner.webp"
        ...
        <section className="py-16 md:py-24 bg-white border-b border-brand-soft">
          <div className="max-w-[1200px] mx-auto px-6">
            <div className="flex flex-wrap justify-center gap-4 md:gap-8">
              {['All Cakes', 'Birthday', 'Wedding', 'Special Occasion', 'Cupcakes', 'Custom'].map((cat, idx) => (
                <div 
                   key={cat} 
        ...
        <section className="relative py-20 px-6 max-w-[1400px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10">
            {PRODUCTS_DATA.map((product, index) => (
              <div key={index} className="bg-white rounded-3xl overflow-hidden shadow-xl shadow-brand-pink/5 hover:-translate-y-2 hover:shadow-2xl hover:shadow-brand-pink/20 transition-all duration-300 group flex flex-col border border-brand-soft/50">
